...
สร้าง Google Spreadsheet ใหม่ ชื่อ "NipponFarm_DB"
สร้าง Sheet ตามรายชื่อด้านล่างทุก Sheet
ตั้งค่า Google Apps Script ตาม Code.gs ที่แนบมา
Deploy เป็น Web App (Execute as: Me, Access: Anyone)
คัดลอก Web App URL ไปใส่ใน script.js ของ Frontend
